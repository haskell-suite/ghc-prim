...
import GHC.Prim (FloatX4#, DoubleX2#, Int32X4#, Int64X2#)
...
#if defined (__GLASGOW_HASKELL_LLVM__)
{-# NOINLINE floatToFloatX4# #-}
floatToFloatX4# :: Float# -> FloatX4#
floatToFloatX4# a1 = (GHC.Prim.floatToFloatX4#) a1
{-# NOINLINE packFloatX4# #-}
packFloatX4# :: Float# -> Float# -> Float# -> Float# -> FloatX4#
packFloatX4# a1 a2 a3 a4 = (GHC.Prim.packFloatX4#) a1 a2 a3 a4
{-# NOINLINE unpackFloatX4# #-}
unpackFloatX4# :: FloatX4# -> (# Float#,Float#,Float#,Float# #)
unpackFloatX4# a1 = (GHC.Prim.unpackFloatX4#) a1
{-# NOINLINE insertFloatX4# #-}
insertFloatX4# :: FloatX4# -> Float# -> Int# -> FloatX4#
insertFloatX4# a1 a2 a3 = (GHC.Prim.insertFloatX4#) a1 a2 a3
{-# NOINLINE plusFloatX4# #-}
plusFloatX4# :: FloatX4# -> FloatX4# -> FloatX4#
plusFloatX4# a1 a2 = (GHC.Prim.plusFloatX4#) a1 a2
{-# NOINLINE minusFloatX4# #-}
minusFloatX4# :: FloatX4# -> FloatX4# -> FloatX4#
minusFloatX4# a1 a2 = (GHC.Prim.minusFloatX4#) a1 a2
{-# NOINLINE timesFloatX4# #-}
timesFloatX4# :: FloatX4# -> FloatX4# -> FloatX4#
timesFloatX4# a1 a2 = (GHC.Prim.timesFloatX4#) a1 a2
{-# NOINLINE divideFloatX4# #-}
divideFloatX4# :: FloatX4# -> FloatX4# -> FloatX4#
divideFloatX4# a1 a2 = (GHC.Prim.divideFloatX4#) a1 a2
{-# NOINLINE negateFloatX4# #-}
negateFloatX4# :: FloatX4# -> FloatX4#
negateFloatX4# a1 = (GHC.Prim.negateFloatX4#) a1
{-# NOINLINE indexFloatX4Array# #-}
indexFloatX4Array# :: ByteArray# -> Int# -> FloatX4#
indexFloatX4Array# a1 a2 = (GHC.Prim.indexFloatX4Array#) a1 a2
{-# NOINLINE readFloatX4Array# #-}
readFloatX4Array# :: MutableByteArray# s -> Int# -> State# s -> (# State# s,FloatX4# #)
readFloatX4Array# a1 a2 a3 = (GHC.Prim.readFloatX4Array#) a1 a2 a3
{-# NOINLINE writeFloatX4Array# #-}
writeFloatX4Array# :: MutableByteArray# s -> Int# -> FloatX4# -> State# s -> State# s
writeFloatX4Array# a1 a2 a3 a4 = (GHC.Prim.writeFloatX4Array#) a1 a2 a3 a4
{-# NOINLINE indexFloatX4OffAddr# #-}
indexFloatX4OffAddr# :: Addr# -> Int# -> FloatX4#
indexFloatX4OffAddr# a1 a2 = (GHC.Prim.indexFloatX4OffAddr#) a1 a2
{-# NOINLINE readFloatX4OffAddr# #-}
readFloatX4OffAddr# :: Addr# -> Int# -> State# s -> (# State# s,FloatX4# #)
readFloatX4OffAddr# a1 a2 a3 = (GHC.Prim.readFloatX4OffAddr#) a1 a2 a3
{-# NOINLINE writeFloatX4OffAddr# #-}
writeFloatX4OffAddr# :: Addr# -> Int# -> FloatX4# -> State# s -> State# s
writeFloatX4OffAddr# a1 a2 a3 a4 = (GHC.Prim.writeFloatX4OffAddr#) a1 a2 a3 a4
{-# NOINLINE indexFloatArrayAsFloatX4# #-}
indexFloatArrayAsFloatX4# :: ByteArray# -> Int# -> FloatX4#
indexFloatArrayAsFloatX4# a1 a2 = (GHC.Prim.indexFloatArrayAsFloatX4#) a1 a2
{-# NOINLINE readFloatArrayAsFloatX4# #-}
readFloatArrayAsFloatX4# :: MutableByteArray# s -> Int# -> State# s -> (# State# s,FloatX4# #)
readFloatArrayAsFloatX4# a1 a2 a3 = (GHC.Prim.readFloatArrayAsFloatX4#) a1 a2 a3
{-# NOINLINE writeFloatArrayAsFloatX4# #-}
writeFloatArrayAsFloatX4# :: MutableByteArray# s -> Int# -> FloatX4# -> State# s -> State# s
writeFloatArrayAsFloatX4# a1 a2 a3 a4 = (GHC.Prim.writeFloatArrayAsFloatX4#) a1 a2 a3 a4
{-# NOINLINE indexFloatOffAddrAsFloatX4# #-}
indexFloatOffAddrAsFloatX4# :: Addr# -> Int# -> FloatX4#
indexFloatOffAddrAsFloatX4# a1 a2 = (GHC.Prim.indexFloatOffAddrAsFloatX4#) a1 a2
{-# NOINLINE readFloatOffAddrAsFloatX4# #-}
readFloatOffAddrAsFloatX4# :: Addr# -> Int# -> State# s -> (# State# s,FloatX4# #)
readFloatOffAddrAsFloatX4# a1 a2 a3 = (GHC.Prim.readFloatOffAddrAsFloatX4#) a1 a2 a3
{-# NOINLINE writeFloatOffAddrAsFloatX4# #-}
writeFloatOffAddrAsFloatX4# :: Addr# -> Int# -> FloatX4# -> State# s -> State# s
writeFloatOffAddrAsFloatX4# a1 a2 a3 a4 = (GHC.Prim.writeFloatOffAddrAsFloatX4#) a1 a2 a3 a4
{-# NOINLINE doubleToDoubleX2# #-}
doubleToDoubleX2# :: Double# -> DoubleX2#
doubleToDoubleX2# a1 = (GHC.Prim.doubleToDoubleX2#) a1
{-# NOINLINE insertDoubleX2# #-}
insertDoubleX2# :: DoubleX2# -> Double# -> Int# -> DoubleX2#
insertDoubleX2# a1 a2 a3 = (GHC.Prim.insertDoubleX2#) a1 a2 a3
{-# NOINLINE packDoubleX2# #-}
packDoubleX2# :: Double# -> Double# -> DoubleX2#
packDoubleX2# a1 a2 = (GHC.Prim.packDoubleX2#) a1 a2
{-# NOINLINE unpackDoubleX2# #-}
unpackDoubleX2# :: DoubleX2# -> (# Double#,Double# #)
unpackDoubleX2# a1 = (GHC.Prim.unpackDoubleX2#) a1
{-# NOINLINE plusDoubleX2# #-}
plusDoubleX2# :: DoubleX2# -> DoubleX2# -> DoubleX2#
plusDoubleX2# a1 a2 = (GHC.Prim.plusDoubleX2#) a1 a2
{-# NOINLINE minusDoubleX2# #-}
minusDoubleX2# :: DoubleX2# -> DoubleX2# -> DoubleX2#
minusDoubleX2# a1 a2 = (GHC.Prim.minusDoubleX2#) a1 a2
{-# NOINLINE timesDoubleX2# #-}
timesDoubleX2# :: DoubleX2# -> DoubleX2# -> DoubleX2#
timesDoubleX2# a1 a2 = (GHC.Prim.timesDoubleX2#) a1 a2
{-# NOINLINE divideDoubleX2# #-}
divideDoubleX2# :: DoubleX2# -> DoubleX2# -> DoubleX2#
divideDoubleX2# a1 a2 = (GHC.Prim.divideDoubleX2#) a1 a2
{-# NOINLINE negateDoubleX2# #-}
negateDoubleX2# :: DoubleX2# -> DoubleX2#
negateDoubleX2# a1 = (GHC.Prim.negateDoubleX2#) a1
{-# NOINLINE indexDoubleX2Array# #-}
indexDoubleX2Array# :: ByteArray# -> Int# -> DoubleX2#
indexDoubleX2Array# a1 a2 = (GHC.Prim.indexDoubleX2Array#) a1 a2
{-# NOINLINE readDoubleX2Array# #-}
readDoubleX2Array# :: MutableByteArray# s -> Int# -> State# s -> (# State# s,DoubleX2# #)
readDoubleX2Array# a1 a2 a3 = (GHC.Prim.readDoubleX2Array#) a1 a2 a3
{-# NOINLINE writeDoubleX2Array# #-}
writeDoubleX2Array# :: MutableByteArray# s -> Int# -> DoubleX2# -> State# s -> State# s
writeDoubleX2Array# a1 a2 a3 a4 = (GHC.Prim.writeDoubleX2Array#) a1 a2 a3 a4
{-# NOINLINE indexDoubleX2OffAddr# #-}
indexDoubleX2OffAddr# :: Addr# -> Int# -> DoubleX2#
indexDoubleX2OffAddr# a1 a2 = (GHC.Prim.indexDoubleX2OffAddr#) a1 a2
{-# NOINLINE readDoubleX2OffAddr# #-}
readDoubleX2OffAddr# :: Addr# -> Int# -> State# s -> (# State# s,DoubleX2# #)
readDoubleX2OffAddr# a1 a2 a3 = (GHC.Prim.readDoubleX2OffAddr#) a1 a2 a3
{-# NOINLINE writeDoubleX2OffAddr# #-}
writeDoubleX2OffAddr# :: Addr# -> Int# -> DoubleX2# -> State# s -> State# s
writeDoubleX2OffAddr# a1 a2 a3 a4 = (GHC.Prim.writeDoubleX2OffAddr#) a1 a2 a3 a4
{-# NOINLINE indexDoubleArrayAsDoubleX2# #-}
indexDoubleArrayAsDoubleX2# :: ByteArray# -> Int# -> DoubleX2#
indexDoubleArrayAsDoubleX2# a1 a2 = (GHC.Prim.indexDoubleArrayAsDoubleX2#) a1 a2
{-# NOINLINE readDoubleArrayAsDoubleX2# #-}
readDoubleArrayAsDoubleX2# :: MutableByteArray# s -> Int# -> State# s -> (# State# s,DoubleX2# #)
readDoubleArrayAsDoubleX2# a1 a2 a3 = (GHC.Prim.readDoubleArrayAsDoubleX2#) a1 a2 a3
{-# NOINLINE writeDoubleArrayAsDoubleX2# #-}
writeDoubleArrayAsDoubleX2# :: MutableByteArray# s -> Int# -> DoubleX2# -> State# s -> State# s
writeDoubleArrayAsDoubleX2# a1 a2 a3 a4 = (GHC.Prim.writeDoubleArrayAsDoubleX2#) a1 a2 a3 a4
{-# NOINLINE indexDoubleOffAddrAsDoubleX2# #-}
indexDoubleOffAddrAsDoubleX2# :: Addr# -> Int# -> DoubleX2#
indexDoubleOffAddrAsDoubleX2# a1 a2 = (GHC.Prim.indexDoubleOffAddrAsDoubleX2#) a1 a2
{-# NOINLINE readDoubleOffAddrAsDoubleX2# #-}
readDoubleOffAddrAsDoubleX2# :: Addr# -> Int# -> State# s -> (# State# s,DoubleX2# #)
readDoubleOffAddrAsDoubleX2# a1 a2 a3 = (GHC.Prim.readDoubleOffAddrAsDoubleX2#) a1 a2 a3
{-# NOINLINE writeDoubleOffAddrAsDoubleX2# #-}
writeDoubleOffAddrAsDoubleX2# :: Addr# -> Int# -> DoubleX2# -> State# s -> State# s
writeDoubleOffAddrAsDoubleX2# a1 a2 a3 a4 = (GHC.Prim.writeDoubleOffAddrAsDoubleX2#) a1 a2 a3 a4
{-# NOINLINE int32ToInt32X4# #-}
int32ToInt32X4# :: Int# -> Int32X4#
int32ToInt32X4# a1 = (GHC.Prim.int32ToInt32X4#) a1
{-# NOINLINE insertInt32X4# #-}
insertInt32X4# :: Int32X4# -> Int# -> Int# -> Int32X4#
insertInt32X4# a1 a2 a3 = (GHC.Prim.insertInt32X4#) a1 a2 a3
{-# NOINLINE packInt32X4# #-}
packInt32X4# :: Int# -> Int# -> Int# -> Int# -> Int32X4#
packInt32X4# a1 a2 a3 a4 = (GHC.Prim.packInt32X4#) a1 a2 a3 a4
{-# NOINLINE unpackInt32X4# #-}
unpackInt32X4# :: Int32X4# -> (# Int#,Int#,Int#,Int# #)
unpackInt32X4# a1 = (GHC.Prim.unpackInt32X4#) a1
{-# NOINLINE plusInt32X4# #-}
plusInt32X4# :: Int32X4# -> Int32X4# -> Int32X4#
plusInt32X4# a1 a2 = (GHC.Prim.plusInt32X4#) a1 a2
{-# NOINLINE minusInt32X4# #-}
minusInt32X4# :: Int32X4# -> Int32X4# -> Int32X4#
minusInt32X4# a1 a2 = (GHC.Prim.minusInt32X4#) a1 a2
{-# NOINLINE timesInt32X4# #-}
timesInt32X4# :: Int32X4# -> Int32X4# -> Int32X4#
timesInt32X4# a1 a2 = (GHC.Prim.timesInt32X4#) a1 a2
{-# NOINLINE quotInt32X4# #-}
quotInt32X4# :: Int32X4# -> Int32X4# -> Int32X4#
quotInt32X4# a1 a2 = (GHC.Prim.quotInt32X4#) a1 a2
{-# NOINLINE remInt32X4# #-}
remInt32X4# :: Int32X4# -> Int32X4# -> Int32X4#
remInt32X4# a1 a2 = (GHC.Prim.remInt32X4#) a1 a2
{-# NOINLINE negateInt32X4# #-}
negateInt32X4# :: Int32X4# -> Int32X4#
negateInt32X4# a1 = (GHC.Prim.negateInt32X4#) a1
{-# NOINLINE indexInt32X4Array# #-}
indexInt32X4Array# :: ByteArray# -> Int# -> Int32X4#
indexInt32X4Array# a1 a2 = (GHC.Prim.indexInt32X4Array#) a1 a2
{-# NOINLINE readInt32X4Array# #-}
readInt32X4Array# :: MutableByteArray# s -> Int# -> State# s -> (# State# s,Int32X4# #)
readInt32X4Array# a1 a2 a3 = (GHC.Prim.readInt32X4Array#) a1 a2 a3
{-# NOINLINE writeInt32X4Array# #-}
writeInt32X4Array# :: MutableByteArray# s -> Int# -> Int32X4# -> State# s -> State# s
writeInt32X4Array# a1 a2 a3 a4 = (GHC.Prim.writeInt32X4Array#) a1 a2 a3 a4
{-# NOINLINE indexInt32X4OffAddr# #-}
indexInt32X4OffAddr# :: Addr# -> Int# -> Int32X4#
indexInt32X4OffAddr# a1 a2 = (GHC.Prim.indexInt32X4OffAddr#) a1 a2
{-# NOINLINE readInt32X4OffAddr# #-}
readInt32X4OffAddr# :: Addr# -> Int# -> State# s -> (# State# s,Int32X4# #)
readInt32X4OffAddr# a1 a2 a3 = (GHC.Prim.readInt32X4OffAddr#) a1 a2 a3
{-# NOINLINE writeInt32X4OffAddr# #-}
writeInt32X4OffAddr# :: Addr# -> Int# -> Int32X4# -> State# s -> State# s
writeInt32X4OffAddr# a1 a2 a3 a4 = (GHC.Prim.writeInt32X4OffAddr#) a1 a2 a3 a4
{-# NOINLINE indexInt32ArrayAsInt32X4# #-}
indexInt32ArrayAsInt32X4# :: ByteArray# -> Int# -> Int32X4#
indexInt32ArrayAsInt32X4# a1 a2 = (GHC.Prim.indexInt32ArrayAsInt32X4#) a1 a2
{-# NOINLINE readInt32ArrayAsInt32X4# #-}
readInt32ArrayAsInt32X4# :: MutableByteArray# s -> Int# -> State# s -> (# State# s,Int32X4# #)
readInt32ArrayAsInt32X4# a1 a2 a3 = (GHC.Prim.readInt32ArrayAsInt32X4#) a1 a2 a3
{-# NOINLINE writeInt32ArrayAsInt32X4# #-}
writeInt32ArrayAsInt32X4# :: MutableByteArray# s -> Int# -> Int32X4# -> State# s -> State# s
writeInt32ArrayAsInt32X4# a1 a2 a3 a4 = (GHC.Prim.writeInt32ArrayAsInt32X4#) a1 a2 a3 a4
{-# NOINLINE indexInt32OffAddrAsInt32X4# #-}
indexInt32OffAddrAsInt32X4# :: Addr# -> Int# -> Int32X4#
indexInt32OffAddrAsInt32X4# a1 a2 = (GHC.Prim.indexInt32OffAddrAsInt32X4#) a1 a2
{-# NOINLINE readInt32OffAddrAsInt32X4# #-}
readInt32OffAddrAsInt32X4# :: Addr# -> Int# -> State# s -> (# State# s,Int32X4# #)
readInt32OffAddrAsInt32X4# a1 a2 a3 = (GHC.Prim.readInt32OffAddrAsInt32X4#) a1 a2 a3
{-# NOINLINE writeInt32OffAddrAsInt32X4# #-}
writeInt32OffAddrAsInt32X4# :: Addr# -> Int# -> Int32X4# -> State# s -> State# s
writeInt32OffAddrAsInt32X4# a1 a2 a3 a4 = (GHC.Prim.writeInt32OffAddrAsInt32X4#) a1 a2 a3 a4
{-# NOINLINE int64ToInt64X2# #-}
int64ToInt64X2# :: Int64# -> Int64X2#
int64ToInt64X2# a1 = (GHC.Prim.int64ToInt64X2#) a1
{-# NOINLINE insertInt64X2# #-}
insertInt64X2# :: Int64X2# -> Int64# -> Int# -> Int64X2#
insertInt64X2# a1 a2 a3 = (GHC.Prim.insertInt64X2#) a1 a2 a3
{-# NOINLINE packInt64X2# #-}
packInt64X2# :: Int64# -> Int64# -> Int64X2#
packInt64X2# a1 a2 = (GHC.Prim.packInt64X2#) a1 a2
{-# NOINLINE unpackInt64X2# #-}
unpackInt64X2# :: Int64X2# -> (# Int64#,Int64# #)
unpackInt64X2# a1 = (GHC.Prim.unpackInt64X2#) a1
{-# NOINLINE plusInt64X2# #-}
plusInt64X2# :: Int64X2# -> Int64X2# -> Int64X2#
plusInt64X2# a1 a2 = (GHC.Prim.plusInt64X2#) a1 a2
{-# NOINLINE minusInt64X2# #-}
minusInt64X2# :: Int64X2# -> Int64X2# -> Int64X2#
minusInt64X2# a1 a2 = (GHC.Prim.minusInt64X2#) a1 a2
{-# NOINLINE timesInt64X2# #-}
timesInt64X2# :: Int64X2# -> Int64X2# -> Int64X2#
timesInt64X2# a1 a2 = (GHC.Prim.timesInt64X2#) a1 a2
{-# NOINLINE quotInt64X2# #-}
quotInt64X2# :: Int64X2# -> Int64X2# -> Int64X2#
quotInt64X2# a1 a2 = (GHC.Prim.quotInt64X2#) a1 a2
{-# NOINLINE remInt64X2# #-}
remInt64X2# :: Int64X2# -> Int64X2# -> Int64X2#
remInt64X2# a1 a2 = (GHC.Prim.remInt64X2#) a1 a2
{-# NOINLINE negateInt64X2# #-}
negateInt64X2# :: Int64X2# -> Int64X2#
negateInt64X2# a1 = (GHC.Prim.negateInt64X2#) a1
{-# NOINLINE indexInt64X2Array# #-}
indexInt64X2Array# :: ByteArray# -> Int# -> Int64X2#
indexInt64X2Array# a1 a2 = (GHC.Prim.indexInt64X2Array#) a1 a2
{-# NOINLINE readInt64X2Array# #-}
readInt64X2Array# :: MutableByteArray# s -> Int# -> State# s -> (# State# s,Int64X2# #)
readInt64X2Array# a1 a2 a3 = (GHC.Prim.readInt64X2Array#) a1 a2 a3
{-# NOINLINE writeInt64X2Array# #-}
writeInt64X2Array# :: MutableByteArray# s -> Int# -> Int64X2# -> State# s -> State# s
writeInt64X2Array# a1 a2 a3 a4 = (GHC.Prim.writeInt64X2Array#) a1 a2 a3 a4
{-# NOINLINE indexInt64X2OffAddr# #-}
indexInt64X2OffAddr# :: Addr# -> Int# -> Int64X2#
indexInt64X2OffAddr# a1 a2 = (GHC.Prim.indexInt64X2OffAddr#) a1 a2
{-# NOINLINE readInt64X2OffAddr# #-}
readInt64X2OffAddr# :: Addr# -> Int# -> State# s -> (# State# s,Int64X2# #)
readInt64X2OffAddr# a1 a2 a3 = (GHC.Prim.readInt64X2OffAddr#) a1 a2 a3
{-# NOINLINE writeInt64X2OffAddr# #-}
writeInt64X2OffAddr# :: Addr# -> Int# -> Int64X2# -> State# s -> State# s
writeInt64X2OffAddr# a1 a2 a3 a4 = (GHC.Prim.writeInt64X2OffAddr#) a1 a2 a3 a4
{-# NOINLINE indexInt64ArrayAsInt64X2# #-}
indexInt64ArrayAsInt64X2# :: ByteArray# -> Int# -> Int64X2#
indexInt64ArrayAsInt64X2# a1 a2 = (GHC.Prim.indexInt64ArrayAsInt64X2#) a1 a2
{-# NOINLINE readInt64ArrayAsInt64X2# #-}
readInt64ArrayAsInt64X2# :: MutableByteArray# s -> Int# -> State# s -> (# State# s,Int64X2# #)
readInt64ArrayAsInt64X2# a1 a2 a3 = (GHC.Prim.readInt64ArrayAsInt64X2#) a1 a2 a3
{-# NOINLINE writeInt64ArrayAsInt64X2# #-}
writeInt64ArrayAsInt64X2# :: MutableByteArray# s -> Int# -> Int64X2# -> State# s -> State# s
writeInt64ArrayAsInt64X2# a1 a2 a3 a4 = (GHC.Prim.writeInt64ArrayAsInt64X2#) a1 a2 a3 a4
{-# NOINLINE indexInt64OffAddrAsInt64X2# #-}
indexInt64OffAddrAsInt64X2# :: Addr# -> Int# -> Int64X2#
indexInt64OffAddrAsInt64X2# a1 a2 = (GHC.Prim.indexInt64OffAddrAsInt64X2#) a1 a2
{-# NOINLINE readInt64OffAddrAsInt64X2# #-}
readInt64OffAddrAsInt64X2# :: Addr# -> Int# -> State# s -> (# State# s,Int64X2# #)
readInt64OffAddrAsInt64X2# a1 a2 a3 = (GHC.Prim.readInt64OffAddrAsInt64X2#) a1 a2 a3
{-# NOINLINE writeInt64OffAddrAsInt64X2# #-}
writeInt64OffAddrAsInt64X2# :: Addr# -> Int# -> Int64X2# -> State# s -> State# s
writeInt64OffAddrAsInt64X2# a1 a2 a3 a4 = (GHC.Prim.writeInt64OffAddrAsInt64X2#) a1 a2 a3 a4
{-# NOINLINE prefetchByteArray# #-}
prefetchByteArray# :: ByteArray# -> Int# -> ByteArray#
prefetchByteArray# a1 a2 = (GHC.Prim.prefetchByteArray#) a1 a2
{-# NOINLINE prefetchMutableByteArray# #-}
prefetchMutableByteArray# :: MutableByteArray# s -> Int# -> State# s -> State# s
prefetchMutableByteArray# a1 a2 a3 = (GHC.Prim.prefetchMutableByteArray#) a1 a2 a3
{-# NOINLINE prefetchAddr# #-}
prefetchAddr# :: Addr# -> Int# -> Addr#
prefetchAddr# a1 a2 = (GHC.Prim.prefetchAddr#) a1 a2
#endif /* defined (__GLASGOW_HASKELL_LLVM__) */
